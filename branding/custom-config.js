...
// 🔑 ЧЁТКОСТЬ ДЕМОНСТРАЦИИ РЕШАЕТСЯ ЗДЕСЬ, а не битрейтом.
// В lib-jitsi-meet жёсткое правило: если max > 5, треку выставляется contentHint="motion" —
// браузеру говорят «это видео, жертвуй резкостью ради плавности», и текст расплывается.
// При max <= 5 ставится contentHint="detail": кодировщик сохраняет разрешение и чёткость букв,
// жертвуя частотой кадров. Для таблиц, документов и презентаций это ровно то, что нужно —
// пять кадров в секунду глазу хватает, а текст остаётся читаемым.
